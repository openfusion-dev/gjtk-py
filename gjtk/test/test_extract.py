...
def error_message(test_data, test_result):
    return '\n'.join(['',
        '// Data',
        json.dumps(test_data, sort_keys=True, indent=2, separators=(',', ': ')),
        '// Result',
        json.dumps(test_result, sort_keys=True, indent=2, separators=(',', ': '))
    ])
...
class positionsOfTest (unittest.TestCase):
    ...
    def test_valid_Point(self):
        ...
        self.assertTrue(all(gjtk.validate.isPosition(position) for position in test_result), error_message(test_data, test_result))
...
class featureOfTest (unittest.TestCase):
    ...
    def test_valid_Feature(self):
        ...
        self.assertTrue(all(gjtk.validate.isFeature(feature) for feature in test_result), error_message(test_data, test_result))
...
class geometriesOf (unittest.TestCase):
    ...
    def test_valid_Point(self):
        ...
        self.assertTrue(all(gjtk.validate.isGeometry(geometry) for geometry in test_result), error_message(test_data, test_result))
